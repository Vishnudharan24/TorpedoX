...
# Train the model
history = model.fit(X_train, y_train, epochs=5, batch_size=8, validation_split=0.2, verbose=2)
...
model.save('diffMiniv1.0_s2.h5')

import joblib
joblib.dump(label_encoder, 'labelEncoder_DiffMiniv1.0s2.pkl')
