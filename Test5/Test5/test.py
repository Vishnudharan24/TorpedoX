...
def predict_algorithm(ciphertext, model, scaler, label_encoder):
    ...
    # Map the predicted class back to the algorithm name using the label encoder
    algorithm = label_encoder.inverse_transform([predicted_class])[0]
...
if __name__ == "__main__":
    ...
    predicted_algorithm = predict_algorithm(user_ciphertext, model, scaler, label_encoder)
    
    print(f"The predicted algorithm is: {predicted_algorithm}")
